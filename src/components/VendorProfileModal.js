      ...
      <View style={styles.menuView}>
        <View style={styles.menuViewContainer}>
          <TextButton
            ...
            appendComponent={<Image source={require('../assets/icons/1.png')} />}
            prependComponent={
          ...
          <TextButton
            ...
            appendComponent={<Image source={require('../assets/icons/2.png')} />}
            prependComponent={
              <Ionicons name="chevron-forward-outline" size={22} />
            }
            labelStyle={{marginLeft: 5, ...FONTS.body4, color: COLORS.black}}
          ...
          <TextButton
            ...
            appendComponent={<Image source={require('../assets/icons/3.png')} />}
            prependComponent={
              <Ionicons name="chevron-forward-outline" size={22} />
            }
            labelStyle={{marginLeft: 5, ...FONTS.body4, color: COLORS.black}}
          ...
          <TextButton
            ...
            appendComponent={<Image source={require('../assets/icons/4.png')} />}
            prependComponent={
              <Ionicons name="chevron-forward-outline" size={22} />
            }
            labelStyle={{marginLeft: 5, ...FONTS.body4, color: COLORS.black}}
          ...
          <TextButton
            ...
            appendComponent={<Image source={require('../assets/icons/5.png')} />}
            prependComponent={
              <Ionicons name="chevron-forward-outline" size={22} />
            }
            labelStyle={{marginLeft: 5, ...FONTS.body4, color: COLORS.black}}
